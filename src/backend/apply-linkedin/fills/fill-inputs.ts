      ...
      if (inputValue === "" && associatedLabel?.length) {
        ...
        if (foundFieldKey) {
          ...
          const prompt = isNumericInput
            ...
            : `${globalPrompt}. The following form item is an input with a label: ${associatedLabel}. Be concise. Please use the format mm/dd/yyyy when entering a date, and give me only the date. Do not exceed 50 to 100 characters.`;
